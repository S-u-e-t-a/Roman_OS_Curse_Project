...
public class secondChance
{
    ...
    private static bool findAndUpdate(int x,
        int[] arr,
        bool[] second_chance,
        int frames)
    ...
    private static int replaceAndUpdate(int x,
        int[] arr,
        bool[] second_chance,
        int frames,
        int pointer)
    ...
    private static void printHitsAndFaults(string reference_string,
        int frames)
    {
        ...
        var second_chance = new bool[frames];

        //Split the string into tokens,
        //that is page numbers, based on space
        var str = reference_string.Split();
